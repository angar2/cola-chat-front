...
export default function MessageHeader() {
  ...
  return (
    <div className="relative w-full">
      ...
      <div className="flex-none flex flex-col w-full h-fit px-4 sm:px-5 2xl:px-6 py-2 2xl:py-4 gap-2 bg-d border-b-[0.4px] border-c border-opacity-50 text-sm sm:text-base font-semibold text-c">
        <div className="flex items-center justify-between">
          <div className="flex gap-1">
            ...
            <div className="w-full overflow-hidden">
              <p className="text-lg sm:text-xl font-semibold text-g truncate">
                {title}
              </p>
            </div>
          </div>
        ...
        <div className="flex justify-between">
          {/* 채팅방 인원수 */}
          <button
            className="relative flex items-center gap-1 active:scale-90"
          ...
          >
            ...
            <span className="font-normal">{onlineBycapacity}</span>
            <Tooltip
