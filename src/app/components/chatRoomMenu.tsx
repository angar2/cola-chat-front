...
export default function ChatRoomMenu() {
  ...
  return (
    <div className="h-full sm:pt-2">
      <div className="sm:hidden absolute top-0 left-1/2 transform translate-x-8 -translate-y-full w-0 h-0 border-x-4 border-x-transparent border-b-4 border-b-a border-opacity-80"></div>
      <div className="flex flex-col gap-3 w-full h-full px-2 py-3 bg-a sm:bg-d bg-opacity-80 sm:bg-opacity-40 rounded sm:rounded-r text-sm font-semibold text-c">
        {/* URL 복사 */}
        <button
        ...
        >
          ...
          <p className="sm:hidden">채팅방 URL 복사</p>
          <Tooltip
            anchorSelect="#copy"
            delayShow={500}
            content="채팅방 URL 복사"
        ...
        >
          ...
          <p className="sm:hidden">닉네임 변경</p>
          <Tooltip
        ...
        {/* 채팅방 만료기한 */}
        <div className="flex items-center gap-1 p-1" id="expiration">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
          ...
          <p className="sm:hidden">채팅방 만료기한</p>
          <Tooltip
        ...
        >
          ...
          <p className="sm:hidden">채팅방 나가기</p>
          <Tooltip
            anchorSelect="#leave"
            delayShow={500}
            content="채팅방 나가기"
